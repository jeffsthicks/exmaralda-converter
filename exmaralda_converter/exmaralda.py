...
class Timepoint:
    ...
    def __init__(self, time_stamp=-1, type='', time_index=-1):
        """
...
class Tier:
    ...
    def add_event(self, e):
        ...
        self.event_dict[e.start.time_index]=e
...
class ExmaraldaTranscript:
    ...
    def load(in_file):
        ...
        for k,time_info in enumerate(root.iter('tli')):
            try: new_tp = Timepoint(time_stamp=time_info.attrib['time'],time_index=k)
            except: new_tp = Timepoint(time_stamp="0",time_index=k) 
